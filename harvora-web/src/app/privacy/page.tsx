...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy" lastUpdated="5 June 2026">
      <p>
        Harvora Limited ("Harvora", "we", "us", "our") operates the Harvora platform at
        harvora.co.nz. This Privacy Policy explains how we collect, use, store, and protect
      ...
      <p>When you create a Harvora account, we collect:</p>
      <ul>
        <li>Full name</li>
        <li>Email address</li>
      ...
      <ul>
        <li>
          It is necessary to provide the Harvora service you requested (Information Privacy
          Principle 1)
        </li>
        <li>
      ...
      <h2>8. Cookies</h2>
      <p>
        Harvora uses essential cookies for authentication and session management. We do not
      ...
      <p>
        Harvora is a professional agricultural tool and is not directed at children under

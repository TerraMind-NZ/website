...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Service" lastUpdated="5 June 2026">
      <p>
        These Terms of Service ("Terms") govern your use of the Harvora platform operated
        by Harvora Limited ("Harvora", "we", "us", "our"), a New Zealand limited company.
        By creating an account or using Harvora, you agree to these Terms.
      </p>
      ...
      <h2>1. The service</h2>
      <p>
        Harvora is a probabilistic forecasting and decision-support platform for New Zealand
      ...
      <p>
        ...
        <a href="mailto:support@harvora.co.nz">support@harvora.co.nz</a> if you suspect
        unauthorised access.
      </p>
      ...
      <ul>
        ...
        <li>
          Reverse-engineer, decompile, or extract the source code of Harvora's prediction
          models
        </li>
        <li>
          Resell, sublicense, or redistribute Harvora data or outputs without written
          permission
        </li>
        <li>
      ...
      <p>
        Harvora provides decision-support calculations based on probabilistic models and
        publicly available data.{" "}
        <strong>
          Harvora does not provide personalised financial advice, investment advice, or
          insurance advice.
        </strong>{" "}
        Recommendations are computed outputs, not professional opinions.
      </p>
      <p>
        Harvora is not a registered financial advice provider under the Financial Markets
      ...
      <p>
        All operational and financial decisions remain yours. Harvora presents options and
        computed expected values; you choose what to do. We are not responsible for losses
        arising from decisions made based on Harvora outputs.
      </p>
      ...
      <p>
        By using Harvora, you grant us a non-exclusive, worldwide license to use your data
        to:
      </p>
      <ul>
        <li>Provide the Harvora service to you</li>
        <li>
      ...
      <h3>6.1 Our IP</h3>
      <p>
        Harvora's prediction models, calibration methodology, economic parameter library,
      ...
      <p>
        Harvora incorporates data from third-party sources including NIWA, MetService,
      ...
      <p>Current operational status is published at harvora.co.nz/status.</p>
      ...
      <p>
        ...
        <a href="mailto:support@harvora.co.nz">support@harvora.co.nz</a> to discuss your
        plan.
      </p>
      ...
      <p>
        ...
        Act 1993, Harvora is provided "as is" and "as available" without warranties of any
      ...
      <p>
        ...
        use of Harvora shall not exceed the amount you paid us in the 12 months preceding
      ...
      <ul>
        <li>Losses arising from decisions you make based on Harvora outputs</li>
      ...
      <p>
        You agree to indemnify and hold harmless Harvora and its founders, employees, and
      ...
      <p>
        ...
        <a href="mailto:support@harvora.co.nz">support@harvora.co.nz</a> or through
        account settings.
      </p>
      ...
      <p>
        ...
        <a href="mailto:legal@harvora.co.nz">legal@harvora.co.nz</a> and attempt to
      ...
      <ul>
        <li>
          <strong>Email:</strong>{" "}
          <a href="mailto:legal@harvora.co.nz">legal@harvora.co.nz</a>
        </li>
        <li>
          <strong>Mail:</strong> Harvora Limited, 368 Blockhouse Bay Rd, Auckland 0600
        </li>
      </ul>
    </LegalPage>
  );

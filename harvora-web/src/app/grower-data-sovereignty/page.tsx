...
export default function GrowerDataSovereigntyPage() {
  return (
    <LegalPage title="Grower Data Sovereignty" lastUpdated="5 June 2026">
      <p>
        Harvora is built on a simple principle: <strong>your orchard data belongs to you.</strong>
      </p>
      <p>
        This is not a marketing statement. It is an architectural commitment encoded into how
        Harvora is built, how your data is stored, and what rights you have over it.
      </p>
      ...
      <p>
        Your data includes everything you provide to Harvora and everything Harvora derives
      ...
      <p>You may delete your Harvora account at any time. When you do:</p>
      <ul>
      ...
      <p>
        ...
        <a href="mailto:support@harvora.co.nz">support@harvora.co.nz</a>.
      </p>
      ...
      <p>
        By using Harvora, you grant us a limited license to use your data as described
        above. This license:
      </p>
      <ul>
      ...
      <p>
        Harvora enriches your orchard data with public and licensed data sources:
      </p>
      <ul>
      ...
      <p>
        Harvora recognises Te Mana Raraunga (Māori Data Sovereignty) principles. As we
      ...
      <ul>
        <li>
          <strong>Email:</strong>{" "}
          <a href="mailto:privacy@harvora.co.nz">privacy@harvora.co.nz</a>
        </li>
        <li>

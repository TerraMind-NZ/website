...
test("Ask Harvora explains provenance reconciliation across predictions", () => {
...
test("proof includes v21 annual-crop capability without changing rejected sections", () => {
  ...
  assert.match(proof, /Every Harvora surface ships with a measured accuracy stat on real\s+New Zealand data/);
